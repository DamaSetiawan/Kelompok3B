...
namespace UTS.Controllers
{
    public class OrderStatusController : Controller
    {
        ...
        public OrderStatusController(BillyardContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("IdStatus,StatusName")] OrderStatus orderStatus)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdStatus,StatusName")] OrderStatus orderStatus)
        {
        ...
        {
            return _context.OrderStatus.Any(e => e.IdStatus == id);
        }
    }
}
